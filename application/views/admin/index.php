				...
				<div class="row">
					...
					<div class="portfolio-item col-sm-4 animate fadeIn">
						<div class="image-hover">
							<a href="#">
								<figure>
									<img src="<?php echo base_url('assets/img/frontpage/filler1.jpg');?>" alt="image1">
									<div class="overlay">
					...
					<div class="portfolio-item col-sm-4 animate fadeIn">
						<div class="image-hover">
							<a href="#">
								<figure>
									<img src="<?php echo base_url('assets/img/frontpage/filler2.jpg');?>" alt="image2">
									<div class="overlay">
										<a class="expand" href="#">Image Link</a>
									</div>
								</figure>
					...
					<div class="portfolio-item col-sm-4 animate fadeIn">
						<div class="image-hover">
							<a href="#">
								<figure>
									<img src="<?php echo base_url('assets/img/frontpage/filler3.jpg');?>" alt="image3">
									<div class="overlay">
										<a class="expand" href="#">Image Link</a>
									</div>
								</figure>
