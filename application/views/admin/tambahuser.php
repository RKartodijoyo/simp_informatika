...
<div class="container">
    <div class="row">
        ...
        echo form_open("admin/tambahuser", $attributes);?>
        <fieldset>
            ...
            <div class="row colbox">
            <div class="col-lg-4 col-sm-4">
                <label for="salary" class="control-label">Tgl Daftar</label>
            </div>
            <div class="col-lg-8 col-sm-8">
                <input id="salary" name="salary" placeholder="Tanggal Pendaftaran" type="date" class="form-control" value="<?php echo set_value('salary'); ?>" />
