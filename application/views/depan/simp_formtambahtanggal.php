...
<head>
    ...
    <title>Form Tambah Tanggal</title>
...
<div class="container">
    <div class="row">
        ...
        echo form_open("depan/simp_formtambahtanggal", $attributes);?>
        <fieldset>
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td><?php echo $rowbarang->tgl_pelaksana?></td>
            </td><td><a href="<?=base_url()?>depan/hapustanggal/<?=$rowbarang->id_tanggal?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin menghapus data ini?')"><i class="glyphicon glyphicon-trash"></i></a>
            </tr>
          <?php }}?>
          </tbody>
          </table>
            ...
            <div class="col-lg-4 col-sm-4">
                <label for="department" class="control-label">Praktikum</label>
            </div>
            ...
            <div class="col-lg-8 col-sm-8">
                <input id="tanggal" name="tanggal" placeholder="Tanggal" type="date" class="form-control"  value="<?php echo set_value('tanggal'); ?>" />
