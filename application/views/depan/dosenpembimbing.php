       ...
       <div class="container">
         ...
         <div class="container">
             <div class="row clear_fix">
                     ...
                     <legend>Dosen Pembimbing</legend>
...
<body>
 <form action="<?php echo site_url('depan/delete_multiple'); ?>" method="post">
  <fieldset>
        <div class="row clear_fix">
...
<div>
  <select name="action">
   ...
   <?php if (count($namaorang)>0){
foreach ($namaorang as $namadosen):
?>
   <option value="<?php echo $namadosen->id?>"><?php echo $namadosen->nama?></option>
<?php endforeach; ?>
  </select>
