    ...
    <div class="row">
      ...
      <?php ?>
        ...
        <td><?php echo $kodeku?></td>
              ...
              <td>
               <a href="<?=base_url()?>depan/verpembayaran/<?php echo $rowbarang->kode_praktikum,'i',$rowbarang->nim?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin menghapus data ini?')"><i class="glyphicon glyphicon-trash"></i></a>
