 ...
 if($this->session->userdata('HAKAKSES_USER') != "3"){echo 'get out';
  ...
  <div class="container">
      <div class="row">
          ...
          <legend>Verifikasi Pengumpulan</legend>
          <?php
          $attributes = array("class" => "form-horizontal", "id" => "employeeform", "name" => "employeeform");
          echo form_open("depan/verifikasipengumpulan", $attributes);?>
          <fieldset>
  ...
  $kodeku="kosong";
        ...
        endforeach;
          ...
          <td><?php echo $kodeku?></td>
                ...
                <td>
                                       <a href="<?=base_url()?>depan/verpengumpulan/<?=$rowbarang->kode_praktikum,'i',$rowbarang->nim?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin menghapus data ini?')"><i class="glyphicon glyphicon-trash"></i></a>
